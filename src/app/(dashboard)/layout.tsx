    ...
    return [
      {
        ...
        logo: (
          <svg
            ...
            className={`h-7 w-7 ${
              tabActive === TAB_ACTIVE.HOME ? "text-primary" : "text-[#CCCCCC]"
            } `}
            viewBox="0 0 20 20"
            fill="currentColor"
          >
      ...
      },
      {
        ...
        logo: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-7 w-7 ${
              tabActive === TAB_ACTIVE.VIDEO ? "text-primary" : "text-[#CCCCCC]"
            } `}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
      ...
      },
      {
        ...
        logo: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-7 w-7 ${
              tabActive === TAB_ACTIVE.GROUP ? "text-primary" : "text-[#CCCCCC]"
            } `}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
      ...
      },
      {
        ...
        logo: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-7 w-7 ${
              tabActive === TAB_ACTIVE.GAME ? "text-primary" : "text-[#CCCCCC]"
            } `}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
