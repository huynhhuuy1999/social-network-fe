...
const listIcon: TypeIcon[] = [
  {
    link: "",
    logo: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-7 w-7 text-[#CCCCCC]"
        viewBox="0 0 20 20"
        fill="currentColor"
      >
...
const DashboardLayout = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div className="bg-[#18191a]">
      <div className="flex  items-center justify-between border-b border-b-[#393a3b] px-3 py-2">
        <div className="flex w-[23%] items-center">
          <Image
