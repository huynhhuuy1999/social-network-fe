...
export const CardAddUser = () => {
  return (
    <div className="w-[160px] cursor-pointer rounded-lg shadow-[0_0_0_1px_#dddfe2] transition-all duration-200  ease-out hover:shadow-[0_1px_8px_5px_#dddfe2] hover:transition-all hover:duration-200">
